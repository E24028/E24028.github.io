...
var scratchblocks = function() {
    ...
    function t(t) {
        for (var s = 1; s < arguments.length; s++) {
            ...
            s % 2 ? e(Object(i), !0).forEach((function(e) {
                r(t, e, i[e])
            }
    ...
    function a(e, t) {
        if (e) {
            ...
            "Map" === s || "Set" === s ? Array.from(e) : "Arguments" === s || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s) ? c(e, t) : void 0
        }
    }
    function c(e, t) {
    ...
    function l(e, t) {
        ...
        if (!s) {
            if (Array.isArray(e) || (s = a(e)) || t && e && "number" == typeof e.length) {
                s && (e = s);
                var i = 0
                  , r = function() {};
                return {
    ...
    var p = {
      ...
      , d = ["motion", "looks", "sound", "variables", "list", "events", "control", "sensing", "operators", "custom", "custom-arg", "extension", "grey", "obsolete"].concat(o(Object.keys(u)), o(Object.keys(f)))
    ...
    x("SOUND_CHANGEEFFECTBY", "LOOKS_CHANGEEFFECTBY", (function(e, t) {
        ...
        try {
            for (i.s(); !(s = i.n()).done; ) {
                var r = s.value;
                if ("dropdown" === r.shape) {
                    var n, o = r.value, a = l(t.soundEffects);
                    try {
                        for (a.s(); !(n = a.n()).done; ) {
                            if (L(n.value) === L(o))
                                return !0
    ...
    x("microbit.whenGesture", "gdxfor.whenGesture", (function(e, t) {
        ...
        try {
            for (i.s(); !(s = i.n()).done; ) {
                var r = s.value;
                if ("dropdown" === r.shape) {
                    var n, o = r.value, a = l(t.microbitWhen);
                    try {
                        for (a.s(); !(n = a.n()).done; ) {
                            if (L(n.value) === L(o))
                                return !0
    ...
    function(e, t) {
        ...
        if (r.isInput) {
            var n = r.value;
            return i.osis.includes(n) ? t(t({}, E.CONTROL_STOP), {}, {
                shape: "stack"
            }) : void 0
        }
    }
    ...
    var P = function() {
      ...
      , z = function() {
        function e(e, t, s) {
            ...
            this.label = this.hasLabel ? new P(t,"literal-" + this.shape) : null,
            this.x = 0
        }
        return i(e, [{
            key: "isInput",
            ...
            value: function() {
                if (this.isColor)
                    ...
                    "[" + this.value + "]";
                var e = (this.value ? this.value + "" : "").replace(/([\]\\])/g, "\\$1").replace(/ v$/, " \\v");
      ...
      , H = function() {
        function e(e, s, i) {
            ...
            this.hasPuzzle = "stack" === r || "hat" === r || "cat" === r || "c-block" === r,
        ...
        return i(e, [{
            ...
            value: function(e) {
                ...
                if (s && r && this.info.selector) {
                    ...
                    if (n && n.length) {
                        var o = n[0];
                        return v.test(o) && t && (o = o.replace(v, t.stringify())),
                        o
                    }
                }
                var a = e || "";
                return (!1 === this.info.categoryIsDefault || "custom-arg" === this.info.category && (this.isReporter || this.isBoolean) || "custom" === this.info.category && "stack" === this.info.shape) && (a && (a += " "),
                a += this.info.category),
                a && (i += " :: " + a),
                this.hasScript ? i + "\nend" : "reporter" === this.info.shape ? "(" + i + ")" : "boolean" === this.info.shape ? "<" + i + ">" : i
            }
        }, {
            key: "translate",
            value: function(e, t) {
                ...
                if (i)
                    if ("PROCEDURES_DEFINITION" !== i) {
                        ...
                        if (n) {
                            ...
                            var c = O(r).parts.map((function(e) {
                                return w(e)
                            }
                            )).filter((function(e) {
                                return e
                              ...
                              , h = 0
                              , p = c.map((function(e) {
                                return h = Math.max(h, e),
                                a[e - 1]
                            }
                            ))
                              , u = a.slice(h);
                            this.children = o.parts.map((function(e) {
                                if (e = e.trim()) {
                                    var t = w(e);
                                    return t ? p[t - 1] : m.test(e) ? new F(e.slice(1)) : new P(e)
                                }
                            }
                            )).filter((function(e) {
                                return e
                            ...
                            u.forEach((function(t, i) {
                                1 === i && "CONTROL_IF" === s.info.id && s.children.push(new P(e.commands.CONTROL_ELSE)),
                                s.children.push(t)
                            }
                            )),
      ...
      , U = function() {
        ...
        return i(e, [{
            ...
            key: "stringify",
            value: function() {
                return this.child.isBlock ? this.child.stringify("+") : this.child.stringify().split("\n").map((function(e) {
                    return "+ " + e
                }
                )).join("\n")
            }
    ...
    function _(e, t, s) {
        ...
        try {
            for (o.s(); !(r = o.n()).done; ) {
                var a = r.value;
                a.isLabel ? n.push(a.value) : a.isIcon ? n.push("@" + a.name) : n.push("_")
            }
        } catch (e) {
            o.e(e)
        } finally {
        ...
        var c, h, p = n.join(" "), u = function(e, t, s, i) {
            var r, n = l(i);
            try {
                for (n.s(); !(r = n.n()).done; ) {
                    var o = r.value;
                    if (Object.prototype.hasOwnProperty.call(o.blocksByHash, e)) {
                        var a, c = o.blocksByHash[e], h = l(c);
                        try {
                            for (h.s(); !(a = h.n()).done; ) {
                                var p = a.value;
                                if (("reporter" !== t.shape || "reporter" === p.shape || "ring" === p.shape) && ("boolean" !== t.shape || "boolean" === p.shape) && (!(c.length > 1 && p.accepts) || p.accepts(t, s, o)))
                                    return p.specialCase && (p = p.specialCase(t, s, o) || p),
                                    {
                                        type: p,
                                        lang: o
                                    }
        ...
        if (u)
            ...
            ("ring" === h.shape ? "reporter" === e.shape : "stack" === e.shape) && (e.shape = h.shape),
            ...
            try {
                for (y.s(); !(f = y.n()).done; ) {
                    ...
                    if (W(t, v)) {
                        e.shape = "define-hat",
                        e.category = "custom";
                        var b = t.splice(v.definePrefix.length, t.length - v.defineSuffix.length).map((function(e) {
        ...
        !function(e, t) {
            ...
            try {
                for (i.s(); !(s = i.n()).done; ) {
                    ...
                    A.test(r) ? (e.color = r,
                    e.category = "",
                    e.categoryIsDefault = !1) : d.includes(r) ? (e.category = r,
                    e.categoryIsDefault = !1) : g.includes(r) ? e.shape = r : "loop" === r ? e.hasLoopArrow = !0 : "+" !== r && "-" !== r || (e.diff = r)
                }
            } catch (e) {
                i.e(e)
            } finally {
        ...
        var w = new H(e,t);
        return h && m.test(h.spec) && w.translate(c, !0),
        "+" === e.diff ? new U(w) : (w.diff = e.diff,
        w)
    }
    function W(e, t) {
    ...
    function Q(e, t) {
        ...
        function u(e) {
            for (var t, s = []; i && "\n" !== i; ) {
                if (("<" === i || ">" === i) && ">" === e && 1 === s.length && !s[s.length - 1].isLabel) {
                    var r = a();
                    if ("[" === r || "(" === r || "<" === r || "{" === r) {
                        t = null,
                        s.push(new P(i)),
                ...
                case "@":
                    n();
                    for (var c = ""; i && /[a-zA-Z]/.test(i); )
                        c += i,
                        n();
                    "cloud" === c ? s.push(new P("☁")) : s.push(Object.prototype.hasOwnProperty.call(F.icons, c) ? new F(c) : new P("@" + c)),
                    t = null;
                    break;
                case "\\":
                    n();
        ...
        function f() {
            ...
            return "]" === i && n(),
            A.test(e) ? new z("color",e) : !t && / v$/.test(e) ? p("dropdown", e.slice(0, e.length - 2)) : new z("string",e)
        }
        function d(e) {
            var t = u(e);
            if (i && "\n" === i && (s = !0,
        ...
        function g() {
            ...
            if (1 === e.length && e[0].isLabel) {
                ...
                if (A.test(t))
                    return new z("color",t)
            }
            if (e.length > 1 && e.every((function(e) {
                return e.isLabel
            }
            )) && "v" === e[e.length - 1].value)
                return e.pop(),
                p("number-dropdown", e.map((function(e) {
                    return e.value
                }
                )).join(" "));
            var s = h("reporter", e);
            if (s.info && "ring" === s.info.shape) {
                var r = s.children[0];
                r && r.isInput && "number" === r.shape && "" === r.value ? s.children[0] = new z("reporter") : (r && r.isScript && r.isEmpty || r && r.isBlock && !r.children.length) && (s.children[0] = new z("stack"))
            }
            return s
        }
        function V() {
    ...
    function Z(e) {
        ...
        function r() {
            ...
            e.hasScript)
                for (; ; ) {
                    var t = n();
                    if (e.children.push(new j(t)),
                    !s || !s.isElse) {
                        s && s.isEnd && i();
                        break
                    }
                    var r, o = l(s.children);
                    try {
                        for (o.s(); !(r = o.n()).done; ) {
                            var a = r.value;
                            e.children.push(a)
            ...
            for (var e = []; s; ) {
                for (var n = []; s && "NL" !== s; ) {
                    var o = r()
                      , a = "+" === o.diff;
                    if (a && (o.diff = null),
                    (o.isElse || o.isEnd) && (o = new H(t(t({}, o.info), {}, {
                        shape: "stack"
                    }),o.children)),
                    a) {
                        var c = n[n.length - 1]
                ...
                for (n.length && e.push(new j(n)); "NL" === s; )
                    i()
            }
            return e
        }()
                ...
                X(e, (function(e) {
                    if (e.isBlock)
                        if ("define-hat" === e.info.shape) {
                            ...
                            var g = B(e);
                            i.has(g) && (e.info.category = "custom-arg",
                            e.info.categoryIsDefault = !1,
                            e.info.selector = "getParam")
                        } else if (Object.prototype.hasOwnProperty.call(J, e.info.selector)) {
      ...
      , se = function() {
        ...
        return i(e, null, [{
            ...
            value: function(e, t) {
                for (var s in t) {
                    var i = t[s] + "";
                    te[s] ? e[s] = i : null != t[s] && Object.prototype.hasOwnProperty.call(t, s) && e.setAttributeNS(null, s, i)
                }
                return e
            }
        }, {
            ...
            value: function(e, t, s) {
                for (var i = !0, r = s.split(/\s+/), n = [], o = 0; o < r.length; o++) {
                    var a = r[o];
                    if ("A" !== a)
                        /[A-Za-z]/.test(a) ? ee(i, "translatePath: invalid argument") : (a = +a,
                        a += i ? e : t,
                        i = !i),
                        n.push(a);
                    else {
            ...
            value: function(e, t, s, i, r, n) {
                return "L " + e + " " + t + " A " + r + " " + n + " 0 0 1 " + s + " " + i
            }
        }, {
            key: "arcw",
            value: function(e, t, s, i, r, n) {
                return "L " + e + " " + t + " A " + r + " " + n + " 0 0 0 " + s + " " + i
            }
        }, {
            key: "roundedPath",
            value: function(t, s) {
                var i = s / 2;
                return ["M", i, 0, e.arc(t - i, 0, t - i, s, i, i), e.arc(i, s, i, 0, i, i), "Z"]
            }
        }, {
            key: "roundedRect",
            value: function(s, i, r) {
                return e.path(t(t({}, r), {}, {
                    path: e.roundedPath(s, i)
                }))
            }
        }, {
            key: "pointedPath",
            ...
            value: function(e, t, s, i) {
                ...
                return s && (r = r.concat(["L", i + 27, t, "L", i + 24, t + 3, "L", i + 16, t + 3, "L", i + 13, t])),
                (r = i > 0 ? r.concat(["L", i + 2, t, "L", i, t + 2]) : r.concat(["L", i + 3, t, "L", 0, t - 3])).join(" ")
            }
        }, {
            key: "getArm",
            value: function(e, t) {
            ...
            value: function(s, i, r) {
                return e.path(t(t({}, r), {}, {
                    path: ["M", 0, 12, e.arc(0, 12, 80, 10, 80, 80), "L", s - 3, 10, "L", s, 13, e.getRightAndBottom(s, i, !0), "Z"]
                }))
            }
        }, {
            key: "curve",
            value: function(e, t, s, i, r) {
                var n = (t + i) / 2;
                return Math.round((e + s) / 2 + (r = r || .42) * (i - t)) + " " + Math.round(n - r * (s - e)) + " " + s + " " + i
            }
        }, {
            key: "procHatBase",
            value: function(s, i, r, n) {
                return r = Math.min(.2, 35 / s),
                e.path(t(t({}, n), {}, {
                    path: ["M", 0, 15, "Q", e.curve(0, 15, s, 15, r), e.getRightAndBottom(s, i, !0), "M", -1, 13, "Q", e.curve(-1, 13, s + 1, 13, r), "Q", e.curve(s + 1, 13, s, 16, .6), "Q", e.curve(s, 16, 0, 16, -r), "Q", e.curve(0, 16, -1, 13, .6), "Z"]
                }))
            }
        }, {
            key: "procHatCap",
            value: function(t, s, i) {
                return e.path({
                    path: ["M", -1, 13, "Q", e.curve(-1, 13, t + 1, 13, i), "Q", e.curve(t + 1, 13, t, 16, .6), "Q", e.curve(t, 16, 0, 16, -i), "Q", e.curve(0, 16, -1, 13, .6), "Z"],
            ...
            value: function(t, s, i) {
                var r = s - 52
                  , n = Math.min(.2, 35 / t);
                return e.move(0, r, e.group([e.procHatBase(t, 52, n, i), e.procHatCap(t, 52, n)]))
            }
        }, {
            key: "mouthRect",
            value: function(s, i, r, n, o) {
                for (var a = n[0].height, c = [e.getTop(s), e.getRightAndBottom(s, a, !0, 15)], l = 1; l < n.length; l += 2) {
                    var h = l + 2 === n.length;
                    a += n[l].height - 3,
                    c.push(e.getArm(s, a));
                    var p = !(h && r)
            ...
            value: function(s, i, r, n, o, a, c) {
                var l = "reporter" === a ? e.roundedPath : "boolean" === a ? e.pointedPath : e.capPath;
                return e.path(t(t({}, c), {}, {
                    path: ["M", 8, 0, e.arcw(8, 0, 0, 8, 8, 8), e.arcw(0, i - 8, 8, i, 8, 8), e.arcw(s - 8, i, s, i - 8, 8, 8), e.arcw(s, 8, s - 8, 0, 8, 8), "Z", e.translatePath(4, r || 4, l(n, o).join(" "))],
                    "fill-rule": "even-odd"
                }))
            }
        }, {
            ...
            value: function(s, i, r) {
                return e.path(t(t({}, r), {}, {
                    class: "sb-comment",
                    path: ["M", 6, 0, e.arc(s - 6, 0, s, 6, 6, 6), e.arc(s, i - 6, s - 6, i, 6, 6), e.arc(6, i, 0, i - 6, 6, 6), e.arc(0, 6, 6, 0, 6, 6), "Z"]
                }))
            }
        }, {
            key: "commentLine",
            value: function(s, i) {
                return e.move(-s, 9, e.rect(s, 2, t(t({}, i), {}, {
      ...
      , ie = function() {
        ...
        return i(e, [{
            ...
            value: function(e, s, i) {
                var r = e.toLowerCase().replace(/gaussian|osite/, "") + "-" + ++this.highestId;
                return this.el.appendChild(se.withChildren(se.el("fe" + e, t(t({}, s), {}, {
                    result: r
                })), i || [])),
                r
            }
            ...
            value: function(e, s, i, r) {
                return this.fe("Composite", t(t({}, r), {}, {
                    operator: e,
                    in: s,
                    in2: i
                }))
        ...
        return i(e, null, [{
            ...
            value: function() {
                return [se.el("path", {
                    ...
                    fill: "#111",
                    id: "delInput"
                }), se.setProps(se.group([se.el("path", {
                    d: "M8 0l2 -2l0 -3l3 0l-4 -5l-4 5l3 0l0 3l-8 0l0 2",
                    fill: "#000",
                    opacity: "0.3"
                }), se.move(-1, -1, se.el("path", {
                    d: "M8 0l2 -2l0 -3l3 0l-4 -5l-4 5l3 0l0 3l-8 0l0 2",
                    fill: "#fff",
                    opacity: "0.9"
                }))]), {
                    id: "loopArrow"
                }), se.setProps(se.group([se.el("rect", {
                    x: "0",
                    y: "0",
                    width: "12",
                    height: "14",
            ...
            value: function() {
                var t = se.el("style");
                return t.appendChild(se.cdata(e.cssContent)),
                t
            }
        }, {
            key: "bevelFilter",
            value: function(e, t) {
                var s = new ie(e)
                  ...
                  , r = t ? -1 : 1
                  , n = s.blur(1, i);
                return s.merge(["SourceGraphic", s.comp("in", s.flood("#fff", .15), s.subtract(i, s.offset(+r, +r, n))), s.comp("in", s.flood("#000", .7), s.subtract(i, s.offset(-r, -r, n)))]),
                s.el
            }
        }, {
            key: "darkFilter",
            ...
            key: "darkRect",
            value: function(e, t, s, i) {
                return se.setProps(se.group([se.setProps(i, {
                    class: "sb-" + s + " sb-darker"
                })]), {
                    width: e,
                    height: t
                })
      ...
      , pe = function() {
        ...
        return i(e, [{
            ...
            value: function() {
                var t = this.value
                  , s = "sb-" + this.cls;
                this.el = se.text(0, 10, t, {
                    class: "sb-label " + s
                });
                var i = e.metricsCache[s];
                if (i || (i = e.metricsCache[s] = Object.create(null)),
                Object.hasOwnProperty.call(i, t))
                    this.metrics = i[t];
                else {
                    var r = /comment-label/.test(this.cls) ? "bold 12px Helvetica, Arial, DejaVu Sans, sans-serif" : /literal/.test(this.cls) ? "normal 9px " + ne : "bold 10px " + ne;
            ...
            value: function(t, s) {
                ...
                return i.font = s,
                {
                    width: i.measureText(t).width + .5 | 0
                }
            }
        }]),
        e
    ...
    var ue = function() {
      ...
      , fe = function() {
        ...
        return i(e, [{
            ...
            value: function(t) {
                var s, i;
                this.hasLabel ? (i = this.label.draw(),
                s = Math.max(14, this.label.width + ("string" === this.shape || "number-dropdown" === this.shape ? 6 : 9))) : s = this.isInset ? 30 : this.isColor ? 13 : null,
                this.hasArrow && (s += 10),
                this.width = s;
                var r = this.height = this.isRound || this.isColor ? 13 : 14
                  , n = e.shapes[this.shape](s, r);
                this.isColor ? se.setProps(n, {
                    fill: this.value
                }) : this.isDarker && (n = ce(s, r, t.info.category, n),
                t.info.color && se.setProps(n, {
                    fill: t.info.color
                }));
                var o = se.group([se.setProps(n, {
                ...
                if (this.hasArrow) {
                    ...
                    o.appendChild(se.move(s - 10, c, se.polygon({
      ...
      , de = function() {
        function e(e) {
            ...
            Object.prototype.hasOwnProperty.call(f, this.info.category) && (this.info.category = f[this.info.category]),
            Object.prototype.hasOwnProperty.call(p, this.info.category) ? this.info.category = p[this.info.category] : Object.prototype.hasOwnProperty.call(u, this.info.category) && (this.info.category = "extension"),
            this.x = 0,
            this.width = null,
            this.height = null,
            this.firstLine = null,
        ...
        return i(e, [{
            ...
            value: function(t, s, i) {
                ...
                if (this.isRing) {
                    ...
                    if (r && (r.isStack || r.isBlock || r.isScript)) {
                        var n = r.isScript ? "stack" : r.isStack ? r.shape : r.info.shape;
            ...
            key: "minDistance",
            value: function(e) {
                return this.isBoolean ? e.isReporter ? 4 + e.height / 4 | 0 : e.isLabel ? 5 + e.height / 2 | 0 : e.isBoolean || "boolean" === e.shape ? 5 : 2 + e.height / 2 | 0 : this.isReporter ? e.isInput && e.isRound || (e.isReporter || e.isBoolean) && !e.hasScript ? 0 : e.isLabel ? 2 + e.height / 2 | 0 : e.height / 2 - 2 | 0 : 0
            }
        }, {
            key: "draw",
            value: function() {
                var t = "define-hat" === this.info.shape
                  ...
                  , u = new c(a)
                  , f = function(e) {
                    0 === y.length ? u.height += r + o : (u.height += e ? 0 : 2,
                    u.y -= 1),
                    a += u.height,
                    y.push(u)
                };
                if (this.info.isRTL) {
                    var d, g = 0, V = function() {
                        s = s.slice(0, g).concat(s.slice(g, d).reverse()).concat(s.slice(d))
                    };
                ...
                if (f(!0),
                h = Math.max(h + 2 * n, this.isHat || this.hasScript ? 83 : this.isCommand || this.isOutline || this.isRing ? 39 : 20),
                this.height = a,
                this.width = p ? Math.max(h, 15 + p) : h,
                t) {
                    var w = Math.min(26, 3.5 + .13 * h | 0) - 18;
                    this.height += w,
                    r += 2 * w
                }
                this.firstLine = y[0],
                ...
                for (var O = [], S = 0, L = y; S < L.length; S++) {
                    var E = L[S];
                    if (E.isScript)
                        O.push(se.move(15, E.y, E.el));
                    else {
                        var T, R = E.height, C = l(E.children);
                        try {
                            for (C.s(); !(T = C.n()).done; ) {
                                var M = T.value;
                                if (M.isArrow)
                                    ...
                                    if (t && M.isLabel ? I += 3 : M.isIcon && (I += 0 | M.dy),
                                    !(this.isRing && (M.y = E.y + I | 0,
                                    M.isInset) || (O.push(se.move(n + M.x, E.y + I | 0, M.el)),
                                    "+" !== M.diff))) {
                ...
                return O.splice(0, 0, x),
                this.info.color && se.setProps(x, {
      ...
      , ge = function() {
        ...
        return i(e, [{
            ...
            value: function() {
                ...
                se.group([se.commentLine(this.hasBlock ? e.lineLength : 0, 6), se.commentRect(this.width, this.height, {
                    class: "sb-comment"
                }), se.move(8, 4, t)])
            }
        }], [{
      ...
      , Ve = function() {
        ...
        return i(e, [{
            ...
            key: "drawSelf",
            value: function() {
                var e, t = this.child, s = this.width, i = this.height - 1;
                return e = t.isScript ? !t.isEmpty && t.blocks[0].isHat ? se.hatRect(s, i) : t.isFinal ? se.capRect(s, i) : se.stackRect(s, i) : t.drawSelf(s, i, []),
                se.setProps(e, {
        ...
        return i(e, [{
            ...
            value: function(e) {
                var t = []
                  , s = 0;
                this.width = 0;
                var i, r = l(this.blocks);
                try {
                    for (r.s(); !(i = r.n()).done; ) {
                        var n = i.value
                          , o = e ? 0 : 2
                          , a = n.draw();
                        if (t.push(se.move(o, s, a)),
                ...
                return !e && V.isGlow && (this.height += 2),
                se.group(t)
            }
        }]),
        e
      ...
      , ve = function() {
        ...
        return i(e, [{
            ...
            value: function(e) {
                ...
                this.measure();
                var t, s = 0, i = 0, r = [], n = l(this.scripts);
                try {
                    for (n.s(); !(t = n.n()).done; ) {
                        var a = t.value;
                        i && (i += 10),
                ...
                return c.appendChild(this.defs = se.withChildren(se.el("defs"), [le("bevelFilter", !1), le("inputBevelFilter", !0), he("inputDarkFilter")].concat(o(ae())))),
            ...
            value: function(e, t) {
                this.toCanvas((function(t) {
                    URL && URL.createObjectURL && Blob && t.toBlob ? t.toBlob((function(t) {
    ...
    var me, ke, Ae = re.makeStyle, we = {
        ...
        return i(e, null, [{
            ...
            value: function(e, t) {
                for (var s in t) {
                    var i = t[s] + "";
                    we[s] ? e[s] = i : null != t[s] && Object.prototype.hasOwnProperty.call(t, s) && e.setAttributeNS(null, s, i)
                }
                return e
            }
        }, {
            ...
            value: function(e, t, s, i) {
                ...
                return s && (r = r.concat(["L " + (i + 48) + " " + t, "c -2 0 -3 1 -4 2", "l -4 4", "c -1 1 -2 2 -4 2", "h -12", "c -2 0 -3 -1 -4 -2", "l -4 -4", "c -1 -1 -2 -2 -4 -2"])),
                0 === i ? (r.push("L", i + 4, t),
                r.push("a 4 4 0 0 1 -4 -4")) : (r.push("L", i + 4, t),
                r.push("a 4 4 0 0 0 -4 4")),
                r.join(" ")
            }
        }, {
            key: "getArm",
            value: function(t, s) {
                return "L 16 " + (s - 4) + "\n      a 4 4 0 0 0 4 4\n      L 28 " + s + " " + e.topNotch(t, s)
            }
        }, {
            key: "getArmNoNotch",
            value: function(e, t) {
            ...
            value: function(s, i, r) {
                return e.path(t(t({}, r), {}, {
                    path: [e.getHatTop(s), e.getRightAndBottom(s, i, !0, 0), "Z"]
                }))
            }
        }, {
            key: "catHat",
            value: function(s, i, r) {
                return e.group([e.path(t(t({}, r), {}, {
                    path: [e.getCatTop(s), e.getRightAndBottom(s, i, !0, 0), "Z"]
                })), e.move(0, 32, e.setProps(e.group([e.el("circle", {
                    cx: 29.1,
                    cy: -3.3,
                    r: 3.4
                }), e.el("circle", {
            ...
            value: function(s, i, r) {
                return e.path(t(t({}, r), {}, {
                    path: [e.getProcHatTop(s), e.getRightAndBottom(s, i, !0, 0), "Z"]
                }))
            }
        }, {
            key: "mouthRect",
            value: function(s, i, r, n, o) {
                for (var a = n[0].height, c = [e.getTop(s), e.getRightAndBottom(s, a, !0, 16)], l = 1; l < n.length; l += 2) {
                    var h = l + 2 === n.length
                      , p = n[l];
                    a += p.height - 3,
                    p.isFinal ? c.push(e.getArmNoNotch(s, a)) : c.push(e.getArm(s, a));
                    var u = !(h && r)
                      , f = h ? 0 : 16;
                    a += n[l + 1].height + 3,
        ...
        e
    }(), Se = new Set(["dropdownArrow", "turnRight", "turnLeft", "loopArrow", "musicBlock", "penBlock", "videoBlock", "ttsBlock", "translationBlock"]), Le = function() {
        function e() {}
        return i(e, null, [{
            key: "cssContent",
            get: function() {
            ...
            key: "makeCommonIcons",
            value: function() {
                return [Oe.setProps(Oe.group([Oe.el("path", {
                    ...
                    fill: "#111",
                    id: "sb3-delInput"
                }), Oe.setProps(Oe.group([Oe.el("rect", {
                    x: "0",
                    y: "0",
                    width: "15",
                    height: "18",
                ...
                }), Oe.setProps(Oe.group([Oe.el("path", {
            ...
            value: function() {
                return [].concat(o(e.makeCommonIcons()), [Oe.setProps(Oe.group([Oe.el("path", {
                    ...
                    fill: "none",
                    "stroke-linejoin": "round"
                }), Oe.setProps(Oe.group([Oe.el("circle", {
                    opacity: .25,
                    cx: 32,
                    cy: 16,
                    r: 4.5
            ...
            key: "iconName",
            value: function(e, t) {
                return "high-contrast" === t && Se.has(e) ? e + "-high-contrast" : e
            }
        }, {
            key: "makeStyle",
            value: function() {
                var t = Oe.el("style");
                return t.appendChild(Oe.cdata(e.cssContent)),
                t
            }
        }, {
            key: "defaultFont",
        ...
        e
    }(), Ee = Le.defaultFont, Te = Le.commentFont, Re = Le.makeStyle, Ce = Le.makeOriginalIcons, Me = Le.makeHighContrastIcons, Ie = Le.iconName, Ne = function() {
        function e(e) {
            n(this, e),
            this.el = null,
            this.height = 12,
    ...
    var xe = function() {
        ...
        return i(e, [{
            ...
            value: function(t, s) {
                ...
                if (this.isBoolean)
                    ...
                    r = this.label.draw(t);
                    var n = this.label.width >= 18 ? 11 : (40 - this.label.width) / 2;
                    i = this.label.width + 2 * n,
                    r = Oe.move(n, 9, r)
                } else
                    i = this.isInset ? 30 : null;
                this.hasArrow && (i += 20),
                this.width = i;
                var o = this.height = 32
                  , a = e.shapes[this.shape](i, o);
                Oe.setProps(a, {
                    class: (this.isColor ? "" : "sb3-" + s.info.category) + " sb3-input sb3-input-" + this.shape
                }),
                this.isColor ? Oe.setProps(a, {
                    fill: this.value
                }) : "dropdown" === this.shape ? s.info.color && Oe.setProps(a, {
                    fill: s.info.color,
                    stroke: "rgba(0, 0, 0, 0.2)"
                }) : "number-dropdown" === this.shape ? (a.classList.add("sb3-" + s.info.category + "-alt"),
                s.info.color && Oe.setProps(a, {
                    fill: "rgba(0, 0, 0, 0.1)",
                    stroke: "rgba(0, 0, 0, 0.15)"
                })) : "boolean" === this.shape && (a.classList.remove("sb3-" + s.info.category),
                a.classList.add("sb3-" + s.info.category + "-dark"),
                s.info.color && Oe.setProps(a, {
                    fill: "rgba(0, 0, 0, 0.15)"
                }));
                var c = Oe.group([a]);
                return this.hasLabel && c.appendChild(r),
                this.hasArrow && c.appendChild(Oe.move(i - 24, 13, Oe.symbol("high-contrast" === t ? "#sb3-dropdownArrow-high-contrast" : "#sb3-dropdownArrow", {}))),
                c
            }
        }], [{
            key: "shapes",
      ...
      , Pe = function() {
        function e(e) {
            ...
            this.info = t({}, e.info),
            Object.prototype.hasOwnProperty.call(f, this.info.category) && (this.info.category = f[this.info.category]),
            Object.prototype.hasOwnProperty.call(u, this.info.category) && (this.children.unshift(new Be),
            this.children.unshift(new xe({
        ...
        return i(e, [{
            ...
            value: function(t) {
                var s = "define-hat" === this.info.shape
                  ...
                  , u = new l(c)
                  , f = function() {
                    0 === b.length ? u.height += o + a : (u.height -= 11,
                    u.y -= 2),
                    c += u.height,
                    b.push(u)
                };
                if (this.info.isRTL) {
                    var d, g = 0, V = function() {
                        i = i.slice(0, g).concat(i.slice(g, d).reverse()).concat(i.slice(d))
                    };
                ...
                for (var y, v, b = [], m = 0; m < i.length; m++) {
                    ...
                    k.isScript && this.isCommand)
                        ...
                        null != i[0]) {
                            ...
                            (this.isCommand || this.isOutline) && !k.isLabel && !k.isIcon && u.width < A && (u.width = A)
                        }
                        k.isIcon && 0 === m && this.isCommand && (u.height = Math.max(u.height, k.height + 8)),
                        k.x = u.width,
                        u.width += k.width,
                ...
                h = Math.max(this.hasScript ? 160 : this.isHat ? 108 : this.isCommand || this.isOutline ? 64 : this.isReporter ? 48 : 0, h),
                    ...
                    if (E.isScript)
                        ...
                        for (var T = E.height, R = 0; R < E.children.length; R++) {
                            ...
                            if (C.isArrow)
                                ...
                                C.isLabel && 0 === L ? M -= 1 : s && C.isLabel ? M += 3 : C.isIcon && (M += 0 | C.dy,
                ...
                return S.splice(0, 0, N),
                this.info.color && Oe.setProps(N, {
                    fill: this.info.color,
                    stroke: "rgba(0, 0, 0, 0.2)"
                }),
                Oe.group(S)
      ...
      , Fe = function() {
        ...
        return i(e, [{
            ...
            value: function(t) {
                ...
                return this.width = this.label.width + 16,
                Oe.group([Oe.commentLine(this.hasBlock ? e.lineLength : 0, 6), Oe.commentRect(this.width, this.height, {
                    class: "sb3-comment"
                }), Oe.move(8, 4, s)])
            }
        }], [{
      ...
      , ze = function() {
        ...
        return i(e, [{
            ...
            value: function() {
                var e, t = this.child, s = this.width, i = this.height - 1;
                return e = t.isScript ? !t.isEmpty && t.blocks[0].isHat ? Oe.hatRect(s, i) : t.isFinal ? Oe.capRect(s, i) : Oe.stackRect(s, i) : t.drawSelf(s, i, []),
                Oe.setProps(e, {
        ...
        return i(e, [{
            ...
            value: function(e, t) {
                var s = []
                  , i = 1;
                this.width = 0;
                var r, n = l(this.blocks);
                try {
                    for (n.s(); !(r = n.n()).done; ) {
                        var o = r.value
                          , a = t ? 0 : 2
                          , c = o.draw(e);
                        if (s.push(Oe.move(a, i, c)),
        ...
        return i(e, [{
            ...
            value: function(e) {
                if ("function" == typeof e)
                    throw Error("render() no longer takes a callback");
                this.measure();
                for (var t = 0, s = 0, i = [], r = 0; r < this.scripts.length; r++) {
                ...
                return o.appendChild(this.defs = Oe.withChildren(Oe.el("defs"), a)),
                o.appendChild(Oe.setProps(Oe.group(i), {
    ...
    var Ke = window.scratchblocks = function(e) {
        ...
        function o(e, t, i, r) {
            ...
            if (r.inline) {
                ...
                i.scripts[0] && !i.scripts[0].isEmpty && (o += " scratchblocks-inline-" + i.scripts[0].blocks[0].shape),
                n.className = o,
                n.style.display = "inline-block",
                n.style.verticalAlign = "middle"
            } else
                (n = s.createElement("div")).className = "scratchblocks";
            n.appendChild(t),
            e.innerHTML = "",
            e.appendChild(n)
        }
        return function(e) {
            se.init(e),
            pe.measuring = se.makeCanvas().getContext("2d")
        }(e),
        function(e) {
            Oe.init(e),
            Ne.measuring = Oe.makeCanvas().getContext("2d")
        }(e),
        {
            allLanguages: C,
            loadLanguages: M,
            ...
            appendStyles: function() {
                s.head.appendChild(Ae()),
                s.head.appendChild(je())
            }
        }
    }(window);
    return Ke.appendStyles(),
    Ke
}();
