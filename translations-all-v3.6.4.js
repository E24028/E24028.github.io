...
!function() {
    ...
    var e = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["атемп", "абжьгара армарахь/арӷьарахь"],
        microbitWhen: ["инаскьагоуп", "идырҵысит", "иԥеит"],
        osis: ["анагӡаҩ егьырҭ ипрограммақәа"],
        definePrefix: ["еиҿкаатәуп"],
        defineSuffix: [],
        palette: {
            Motion: "Аиҭаҵра",
            Looks: "Аԥшра-асахьа",
        ...
        math: ["abs", "еиҵоу еибгоу", "еиҳау еибгоу", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Аҧсшәа",
      ...
      , a = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["toonhoogte", "swenk links/regs"],
        microbitWhen: ["geskuif", "geskud", "gespring"],
        osis: ["ander skripte in sprite"],
        definePrefix: ["definieer"],
        defineSuffix: [],
        palette: {
            Motion: "Beweging",
            Looks: "Voorkoms",
        ...
        math: ["abs", "afrond", "oprond", "vierkantswortel", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Afrikaans",
        percentTranslated: 100
    }
      , o = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ፒች", "ሸብልል ወደ ግራ/ቀኝ"],
        microbitWhen: ["ተንቀሳቅሷል", "አራድቷል", "ዘልሏል"],
        osis: ["ሌሎች በስፕራይት ላይ ያሉ ስክሪፕቶች"],
        definePrefix: [],
        defineSuffix: ["ን", "ደንግግ"],
        palette: {
            Motion: "እንቅስቃሴ",
        ...
        math: ["abs", "መሬት", "ጣራ", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ውስጥ", "ግባ", "e^", "10 ^"],
        aliases: {},
        name: "አማርኛ",
        percentTranslated: 100
    }
      , t = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tono", "balanz zurda/dreita"],
        microbitWhen: ["moviu", "sobatiu", "blincau"],
        osis: ["atros programas en l'obchecto"],
        definePrefix: ["definir"],
        defineSuffix: [],
        palette: {
            Motion: "Movimiento",
            Looks: "Apariencia",
        ...
        math: ["valor absoluta", "suelo", "teito", "radiz quadrada", "sen", "cos", "tan", "arcsen", "arccos", "arctan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Aragonés",
        percentTranslated: 100
    }
      , n = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["طبقة الصوت", "توزيع الصوت يسار/يمين"],
        microbitWhen: ["الحركة", "الهز", "القفز"],
        osis: ["المقاطع الأخرى في الكائن"],
        definePrefix: ["عرِّف"],
        defineSuffix: [],
        palette: {
            Motion: "الحركة",
        ...
        math: ["القيمة المطلقة", "الجزء الصحيح", "السقف", "الجذر التربيعي", "الجيب (sin)", "جيب التمام (cos)", "الظل (tan)", "الجيب العكسي (asin)", "جيب التمام العكسي (acos)", "الظل العكسي (atan)", "اللوغارتم الطبيعي", "اللوغارتم العشري", "هـ^", "10^"],
        aliases: {},
        name: "العربية",
        percentTranslated: 100
    }
      , O = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tonu", "panéu izquierda/drecha"],
        microbitWhen: ["movió", "batulláu", "saltó"],
        osis: ["otros scripts nel personaxe"],
        definePrefix: ["definir"],
        defineSuffix: [],
        palette: {
            Motion: "Movimientu",
        ...
        math: ["abs", "suelu", "techu", "raíz", "sen", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Asturianu",
        percentTranslated: 100
    }
      , i = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["kökləmək", "tas sol/sağ"],
        microbitWhen: ["moved", "shaken", "jumped"],
        osis: ["spraytın digər skriptləri"],
        definePrefix: [],
        defineSuffix: ["təyin", "et"],
        palette: {
            Motion: "Hərəkət",
            Looks: "Görünüş",
            Sound: "Səs",
        ...
        math: ["modul", "aşağı yuvarlaqlaşdır", "yuxarı yuvarlaqlaşdır", "kvadrat kök", "sin", "cos", "tg", "arcsin", "arccos", "arctg", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Azeri",
        percentTranslated: 100
    }
      , T = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["вышыня гуку", "рух налева/направа"],
        microbitWhen: ["зрушыць", "патрэсці", "падкінуць"],
        osis: ["іншыя скрыпты спрайта"],
        definePrefix: ["вызначыць"],
        defineSuffix: [],
        palette: {
            Motion: "Рух",
            Looks: "Выгляд",
        ...
        math: ["модуль", "меншае цэлае", "ліміт", "квадратны корань", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Беларуская",
        percentTranslated: 100
    }
      , E = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["промяна на тона", "ляво/дясно"],
        microbitWhen: ["преместен", "разтърсен", "подхвърлен"],
        osis: ["другите скриптове на спрайта"],
        definePrefix: ["дефинирай"],
        defineSuffix: [],
        palette: {
            Motion: "Движение",
            Looks: "Външност",
        ...
        math: ["абсолютна стойност", "закръглено надолу", "закръглено нагоре", "квадратен корен", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e^", "10 ^"],
        aliases: {},
        name: "Български",
        percentTranslated: 100
    }
      , s = {
        ...
        microbitWhen: ["সরানো হয়েছে", "ঝাঁকাও", "লাফ দিয়েছিল"],
        osis: ["স্প্রাইটে অন্যান্য স্ক্রিপ্টসমূহ"],
        definePrefix: ["ডিফাইন"],
        defineSuffix: [],
        palette: {
            Motion: "গতি",
      ...
      , r = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["pitch", "pan esquerra/dreta"],
        microbitWhen: ["es mogui", "es sacsegi", "salti"],
        osis: ["altres programes del personatge"],
        definePrefix: ["defineix"],
        defineSuffix: [],
        palette: {
            Motion: "Moviment",
            Looks: "Aspecte",
        ...
        math: ["abs", "part sencera", "sostre", "arrel quadrada", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , S = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["بەرزی دەنگ", "سوڕانەوە چەپ/ڕاست"],
        microbitWhen: ["جوڵاو", "هەژاو", "بازدراو"],
        osis: ["سکریپتەکانی تر لە تەن"],
        definePrefix: ["پێناسەی"],
        defineSuffix: [],
        palette: {
            Motion: "جوڵان",
            Looks: "ڕوانین",
        ...
        math: ["ڕەگی دووجا", "زەوی", "بنمیچ", "ڕەگی دووجا", "تەژێ", "تەژێ تەواو", "تانجێنت", "asin", "acos", "atan", "لن", "لۆگاریتم", "e ^", "10 ^"],
        aliases: {},
        name: "کوردیی ناوەندی",
        percentTranslated: 100
    }
      , N = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["poloha", "stereo vlevo/vpravo"],
        microbitWhen: ["se pohne", "se zatřese", "poskočí"],
        osis: ["jiné scénáře postavy"],
        definePrefix: ["scénář", "pro"],
        defineSuffix: [],
        palette: {
            Motion: "Pohyb",
            Looks: "Vzhled",
        ...
        math: ["abs", "zaokr. dolů", "zaokr. nahoru", "odmocnina", "sin", "cos", "tg", "arcsin", "arccos", "arctg", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , l = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["traw", "troi chwith/de"],
        microbitWhen: ["symudodd", "ysgydwyd", "neidiodd"],
        osis: ["sgriptiau eraill yn y ciplun"],
        definePrefix: ["diffinio"],
        defineSuffix: [],
        palette: {
            Motion: "Symudiad",
            Looks: "Edrychiad",
        ...
        math: ["abs", "llawr", "nenfwd", "ail isradd", "sin", "cos", "tan", "asin", "acos", "atan", "Yn", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , A = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tonehøjde", "balance venstre/højre"],
        microbitWhen: ["bevæget", "rystet", "hoppet"],
        osis: ["andre scripts i sprite"],
        definePrefix: ["definer"],
        defineSuffix: [],
        palette: {
            Motion: "Bevægelse",
            Looks: "Udseende",
        ...
        math: ["abs", "rund ned", "rund op", "kvrod", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Dansk",
        percentTranslated: 100
    }
      , _ = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["Höhe", "Aussteuern links/rechts"],
        microbitWhen: ["bewegt", "geschüttelt", "hochgehüpft"],
        osis: ["andere Skripte der Figur"],
        definePrefix: ["Definiere"],
        defineSuffix: [],
        palette: {
            Motion: "Bewegung",
            Looks: "Aussehen",
        ...
        math: ["Betrag", "abrunden", "aufrunden", "Wurzel", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e^", "10^"],
        aliases: {
      ...
      , d = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["τόνος", "μετατόπιση αριστερά/δεξιά"],
        microbitWhen: ["κινηθεί", "τρανταχθεί", "αναπηδήσει"],
        osis: ["άλλα σενάρια σε αυτό το αντικείμενο"],
        definePrefix: ["ορισμός"],
        defineSuffix: [],
        palette: {
            Motion: "Κίνηση",
            Looks: "Όψεις",
        ...
        math: ["απόλυτο", "στρογγυλ. κάτω", "στρογγυλ. άνω", "τετρ. ρίζα", "ημ", "συν", "εφ", "τοξημ", "τοξσυν", "τοξεφ", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , I = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tonalto", "aŭdigi maldekstre/dekstre"],
        microbitWhen: ["movita", "ŝancelita", "saltigita"],
        osis: ["aliajn skriptojn en la rolulo"],
        definePrefix: ["difini"],
        defineSuffix: [],
        palette: {
            Motion: "Movado",
        ...
        math: ["abs", "planko", "plafono", "radiko", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Esperanto",
        percentTranslated: 100
    }
      , R = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["altura", "balance izquierda/derecha"],
        microbitWhen: ["mover", "agitar", "saltar"],
        osis: ["otros programas en el objeto"],
        definePrefix: ["definir"],
        defineSuffix: [],
        palette: {
            Motion: "Movimiento",
        ...
        math: ["valor absoluto", "suelo", "techo", "raíz cuadrada", "sen", "cos", "tan", "arcsen", "arccos", "arctan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , u = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tono", "paneo izquierda/derecha"],
        microbitWhen: ["mover", "agitar", "saltar"],
        osis: ["otros programas en el objeto"],
        definePrefix: ["definir"],
        defineSuffix: [],
        ...
        math: ["valor absoluto", "piso", "techo", "raíz cuadrada", "sen", "cos", "tan", "arcsen", "arccos", "arctan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
      ...
      , m = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["helikõrgus", "heli vasakul/paremal"],
        microbitWhen: ["liikus", "rappus", "hüppas"],
        osis: ["teised spraidi skriptid"],
        definePrefix: ["defineeri"],
        defineSuffix: [],
        palette: {
            Motion: "Liikumine",
            Looks: "Välimus",
      ...
      , L = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tonua", "ezker/eskuin balantzea"],
        microbitWhen: ["mugitua", "astindua", "salto egina"],
        osis: ["pertsonaiaren beste script batzuk"],
        definePrefix: ["definitu"],
        defineSuffix: [],
        palette: {
            Motion: "Mugimendua",
            Looks: "Itxura",
        ...
        math: ["balio absolutu", "zoru-funtzioa", "sabai-funtzioa", "erro karratua", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Euskara",
        percentTranslated: 100
    }
      , g = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["زیری یا بمی", "پخش صدا از چپ/راست"],
        microbitWhen: ["حرکت کرد", "تکان داده شد", "پرید"],
        osis: ["سایر برنامه‌های این شکلک"],
        definePrefix: ["تعریف"],
        defineSuffix: [],
        palette: {
            Motion: "حرکت",
        ...
        math: ["قدر مطلق", "جزء صحیح", "سقف", "جذر", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e به توان", "۱۰ به توان"],
        aliases: {
      ...
      , c = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["sävelkorkeus", "panoroi vasen/oikea"],
        microbitWhen: ["siirretty", "ravistettu", "hypätty"],
        osis: ["hahmon muut koodit"],
        definePrefix: ["määrittele"],
        defineSuffix: [],
        palette: {
            Motion: "Liike",
            Looks: "Ulkonäkö",
        ...
        math: ["itseisarvo", "pyöristä alaspäin", "pyöristä ylöspäin", "neliöjuuri", "sini", "kosini", "tangentti", "asin", "acos", "atan", "luonnollinen logaritmi", "10-kantainen logaritmi", "e ^", "10 ^"],
        aliases: {},
        name: "Suomi",
        percentTranslated: 100
    }
      , C = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tinis", "i-pan kaliwa/kanan"],
        microbitWhen: ["gumalaw", "niyugyog", "tumalon"],
        osis: ["ibang script sa sprite"],
        definePrefix: ["i-define", "ang"],
        defineSuffix: [],
        palette: {
            Motion: "Galaw",
            Looks: "Hitsura",
      ...
      , D = {
        ...
        math: ["abs", "plancher", "plafond", "racine", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e^", "10^"],
        aliases: {
      ...
      , p = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["toanhichte", "ferskowe links/rjochts"],
        microbitWhen: ["bewege", "skodde", "sprong"],
        osis: ["oare skripts yn sprite"],
        definePrefix: ["definiearje"],
        defineSuffix: [],
        palette: {
            Motion: "Beweging",
            Looks: "Ferskining",
        ...
        math: ["abs", "flier", "plafond", "woartel", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Frysk",
        percentTranslated: 100
    }
      , h = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tuinairde", "peanáil ar chlé/ar dheis"],
        microbitWhen: ["bogtha", "croite", "léimthe"],
        osis: ["scripteanna eile sa sprid"],
        definePrefix: ["sainmhínigh"],
        defineSuffix: [],
        palette: {
            Motion: "Gluaiseacht",
            Looks: "Cuma",
        ...
        math: ["abs", "urlár", "síleáil", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Gaeilge",
        percentTranslated: 100
    }
      , k = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["gleusa", "panachaidh gu clì/deas"],
        microbitWhen: ["gluasad", "crith", "leum"],
        osis: ["sgriobtaichean eile na sprìde"],
        definePrefix: ["mìnich"],
        defineSuffix: [],
        palette: {
            Motion: "Gluasad",
        ...
        math: ["an luach absaloideach", "an cuairteachadh sìos", "an cuairteachadh suas", "am freumh ceàrnagach", "an sìneas", "an co-shìneas", "am beantan", "an t-àrc-shìneas", "an t-àrc-cho-shìneas", "an t-àrc-bheantan", "an log-àireamh nàdarra", "an log-àireamh", "e ^", "10 ^"],
        aliases: {
      ...
      , P = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ton", "canle esquerda/dereita"],
        microbitWhen: ["movido", "abalado", "saltado"],
        osis: ["outros programas na figura"],
        definePrefix: ["definir"],
        defineSuffix: [],
        palette: {
            Motion: "Movemento",
        ...
        math: ["valor absoluto", "chan", "teito", "raíz cadrada", "seno", "coseno", "tanxente", "arco seno", "arco coseno", "arco tanxente", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Galego",
        percentTranslated: 100
    }
      , G = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tsarin sauti", "fitar da sauti a hagu/dama"],
        microbitWhen: ["an motsa", "an girgiza", "anyi tsalle"],
        osis: ["sauran rubutun cikin sprite"],
        definePrefix: ["ayyana"],
        defineSuffix: [],
        palette: {
            Motion: "motsi",
        ...
        math: ["abs", "ƙasa", "rufi", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "In", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Hausa",
        percentTranslated: 100
    }
      , M = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["גובה צליל", "ערוץ שמע שמאלי/ימני"],
        microbitWhen: ["זז", "רעד", "קפץ"],
        osis: ["תסריטים אחרים בדמות"],
        definePrefix: ["הגדר"],
        defineSuffix: [],
        palette: {
            Motion: "תנועה",
        ...
        math: ["ערך מוחלט", "עיגול למטה", "עיגול למעלה", "שורש ריבועי", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "‏e בחזקה", "‏10 בחזקה"],
        aliases: {
      ...
      , b = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ध्वनि अंक", "पुँछ बाएँ / दांए"],
        microbitWhen: ["स्थलांतरित", "हिला हुआ", "छलाँग"],
        osis: ["पात्र के लिये दूसरी लिपि"],
        definePrefix: ["व्याख्या"],
        defineSuffix: [],
        palette: {
            Motion: "चाल",
            Looks: "रूप",
        ...
        math: ["निरपेक्ष मूल्य", "floor", "ceiling", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10^"],
        aliases: {
      ...
      , w = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["visina tona", "kretanje lijevo/desno"],
        microbitWhen: ["pomaknuto", "protresen", "skok"],
        osis: ["druge programe lika"],
        definePrefix: ["definiraj"],
        defineSuffix: [],
        palette: {
            Motion: "Kretanje",
            Looks: "Izgled",
        ...
        math: ["apsolutno", "donja vrijednost", "gornja vrijednost", "korijen", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , F = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ton", "voye sou bò goch/dwat"],
        microbitWhen: ["deplase", "te souke", "sote"],
        osis: ["lòt eskrip nan aktè la"],
        definePrefix: ["defini"],
        defineSuffix: [],
        palette: {
            Motion: "Mouvman",
        ...
        math: ["abs", "desann pou awondi chif la", "monte pou awondi chif la", "rasin kare", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Kreyòl ayisyen",
        percentTranslated: 100
    }
      , y = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["hangmagasság", "pásztázás balra/jobbra"],
        microbitWhen: ["elmozdult", "megrázva", "átugrott"],
        osis: ["szereplő többi eljárása"],
        definePrefix: [],
        defineSuffix: ["meghatározása"],
        palette: {
            Motion: "Mozgás",
            Looks: "Kinézet",
            Sound: "Hang",
        ...
        math: ["abszolut érték", "lefelé kerekítve", "felfelé kerekítve", "gyök", "sin", "cos", "tg", "arcsin", "arccos", "arctan", "ln", "log", "e^", "10^"],
        aliases: {
      ...
      , U = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["խոսք", "տարածում ձախ/աջ"],
        microbitWhen: ["շարժված", "թափահարած", "ցատկած"],
        osis: ["կերպարի այլ սցենարները"],
        definePrefix: ["սահմանել"],
        defineSuffix: [],
        palette: {
            Motion: "Շարժ",
            Looks: "Տեսք",
        ...
        math: ["մոդուլ", "ամբողջ թիվ՝ վար", "ամբողջ թիվ՝ վեր", "արմատ", "sin", "cos", "tan", "arcsin", "arccos", "arctan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Հայերեն",
        percentTranslated: 100
    }
      , B = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["nada", "pan kiri/kanan"],
        microbitWhen: ["bergerak", "tergoyang", "melompat"],
        osis: ["skrip lain di sprite ini"],
        definePrefix: ["artikan"],
        defineSuffix: [],
        palette: {
            Motion: "Gerakan",
            Looks: "Tampilan",
        ...
        math: ["abs", "floor", "ceil", "akar kuadrat", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , f = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tónhæð", "skima til vinstri/hægri"],
        microbitWhen: ["moved", "shaken", "jumped"],
        osis: ["önnur forrit á karakter"],
        definePrefix: ["skilgreina"],
        defineSuffix: [],
        palette: {
            Motion: "Hreyfing",
            Looks: "Útlit",
        ...
        math: ["abs", "rúna niður", "rúna upp", "kvaðratrót", "sínus", "kósínus", "tangens", "arksínus", "arkcósínus", "arktangens", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Íslenska",
        percentTranslated: 100
    }
      , H = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["frequenza", "panning sinistra/destra"],
        microbitWhen: ["si muove", "si scuote", "salta"],
        osis: ["tutti gli altri script dello sprite"],
        definePrefix: ["definisci"],
        defineSuffix: [],
        palette: {
            Motion: "Movimento",
            Looks: "Aspetto",
        ...
        math: ["valore assoluto", "intero inferiore", "intero superiore", "radice quadrata", "sen", "cos", "tan", "arcsen", "arccos", "arctan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , v = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ピッチ", "左右にパン"],
        microbitWhen: ["動いた", "振られた", "ジャンプした"],
        osis: ["スプライトの他のスクリプトを止める"],
        definePrefix: ["定義"],
        defineSuffix: [],
        palette: {
            Motion: "動き",
        ...
        math: ["絶対値", "切り下げ", "切り上げ", "平方根", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , K = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ピッチ", "さゆうにパン"],
        microbitWhen: ["うごいた", "ふられた", "ジャンプした"],
        osis: ["スプライトのほかのスクリプトをとめる"],
        definePrefix: ["ていぎ"],
        defineSuffix: [],
        palette: {
            Motion: "うごき",
        ...
        math: ["ぜったいち", "きりさげ", "きりあげ", "へいほうこん", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , W = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ბგერის სიმაღლე", "ხმა მარცხნიდან/მარჯვნიდან"],
        microbitWhen: ["გადაადგილდა", "შეირხა", "გადახტა"],
        osis: ["სპრაიტის სხვა სკრიპტები"],
        definePrefix: ["განსაზღვრე"],
        defineSuffix: [],
        palette: {
            Motion: "მოძრაობა",
            Looks: "გარეგნობა",
        ...
        math: ["abs", "უმცირესი მთელი", "უდიდესი მთელი", "კვადრატული ფესვი", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10^"],
        aliases: {},
        name: "ქართული ენა",
        percentTranslated: 100
    }
      , V = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["лақтыру", "оң/сол қыздыру"],
        microbitWhen: ["қозғалды", "шайқалды", "секірді"],
        osis: ["спрайттағы басқа скрипттер"],
        definePrefix: [],
        defineSuffix: ["ге", "мән", "бер"],
        palette: {
            Motion: "Қозғалыс",
            Looks: "Келбет",
            Sound: "Дыбыс",
        ...
        math: ["модуль", "еден", "шектеу", "квадрат түбір", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "қазақша",
        percentTranslated: 100
    }
      , x = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["កម្រិតខ្ពស់ទាប", "កម្រិតឆ្វេងស្តាំ"],
        microbitWhen: ["បានផ្លាស់ទី", "ញាក់", "បានលោត"],
        osis: ["ស្រ្គីបផ្សេងទៀតក្នុងតួអង្គ"],
        definePrefix: ["កំណត់ន័យ"],
        defineSuffix: [],
        palette: {
            Motion: "ចលនា",
            Looks: "រូបរាង",
        ...
        math: ["តម្លៃដាច់ខាត", "បង្គត់ចុះ", "បង្គត់ឡើង", "ឫស​ការ៉េ", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "ភាសាខ្មែរ",
        percentTranslated: 100
    }
      , Y = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["음 높이", "음향 위치 왼쪽/오른쪽"],
        microbitWhen: ["움직일", "흔들어졌을", "점프하였을"],
        osis: ["이 스프라이트에 있는 다른 스크립트"],
        definePrefix: [],
        defineSuffix: ["정의하기"],
        palette: {
            Motion: "동작",
        ...
        math: ["절댓값", "버림", "올림", "제곱근", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "한국어",
        percentTranslated: 100
    }
      , z = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["perdeya deng", "bikişîne rastê-çepê"],
        microbitWhen: ["veguheztî", "hejandî", "gavkirî"],
        osis: ["di pêlîstikê de rêzikên din"],
        definePrefix: [],
        defineSuffix: ["ê", "pênase", "bike"],
        palette: {
            Motion: "Tevger",
            Looks: "Xuyang",
            Sound: "Deng",
        ...
        math: ["nirxê mutlaq", "bigindirîne erdê", "bigindirîne jorê", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "In", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Kurdî",
        percentTranslated: 100
    }
      , j = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["garso aukštis", "kairiau/dešiniau"],
        microbitWhen: ["pajudinta", "papurtyta", "šuolis"],
        osis: ["kitus veikėjo scenarijus"],
        definePrefix: ["komanda"],
        defineSuffix: [],
        palette: {
            Motion: "Judėjimas",
            Looks: "Išvaizda",
        ...
        math: ["teigiama reikšmė", "apvalinimas žemyn", "apvalinimas aukštyn", "kvadratinė šaknis", "sin", "cos", "tg", "arcsin", "arccos", "arctg", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Lietuvių",
        percentTranslated: 100
    }
      , X = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["augstums", "bīdīt pa labi/pa kreisi"],
        microbitWhen: ["pārvietojās", "pakratījās", "palēcās"],
        osis: ["citi skripti gariņā"],
        definePrefix: ["definēt"],
        defineSuffix: [],
        palette: {
            Motion: "Kustība",
            Looks: "Izskats",
        ...
        math: ["modulis (absolūtā vērtība)", "apaļot uz leju", "apaļot uz augšu", "kvadrātsakne", "sin", "cos", "tan", "asin", "acos", "atan", "In", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Latviešu",
        percentTranslated: 100
    }
      , q = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["hauoro", "huri whakatemauī/whakatekatau"],
        microbitWhen: ["i neke", "i rūrū", "i peke"],
        osis: ["hōtuhi kē i roto i te parehe"],
        definePrefix: ["tautuhia"],
        defineSuffix: [],
        palette: {
            Motion: "Nekehanga",
            Looks: "Āhua",
        ...
        math: ["abs", "papa", "tuanui", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Māori",
        percentTranslated: 100
    }
      , Z = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["авиа", "pan зүүн/баруун"],
        microbitWhen: ["хөдөлсөн", "сэгсрэгдсэн", "үсэрсэн"],
        osis: ["дүрсний бусад кодууд"],
        definePrefix: [],
        defineSuffix: ["-г", "зохио"],
        palette: {
            Motion: "Хөдлөхүй",
            Looks: "Харагдахуй",
            Sound: "Сонсогдохуй",
        ...
        math: ["модуль", "доош бүхэлд тоймлох", "дээш бүхэлд тоймлох", "квадрат язгуур", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Монгол хэл",
        percentTranslated: 100
    }
      , J = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tonehøyde", "retning"],
        microbitWhen: ["flyttet", "ristet", "hoppet"],
        osis: ["andre skript i figuren"],
        definePrefix: ["definer"],
        defineSuffix: [],
        palette: {
            Motion: "Bevegelse",
        ...
        math: ["absoluttverdi", "avrund ned", "avrund opp", "kvadratrot", "sin", "cos", "tan", "arcsin", "arccos", "arctan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , Q = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["toonhoogte", "kanaal links/rechts"],
        microbitWhen: ["bewogen", "geschud", "gesprongen"],
        osis: ["andere scripts in sprite"],
        definePrefix: ["definieer"],
        defineSuffix: [],
        palette: {
            Motion: "Beweging",
        ...
        math: ["absoluut", "beneden", "boven", "wortel", "sin", "cos", "tan", "arcsin", "arccos", "arctan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , $ = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tonehøgd", "venstre–høgre-panorering"],
        microbitWhen: ["flytta", "rista", "hoppa"],
        osis: ["andre skript i figuren"],
        definePrefix: ["definer"],
        defineSuffix: [],
        palette: {
        ...
        math: ["abs", "golv", "tak", "kvadratrot", "sin", "cos", "tan", "arcsin", "arccos", "arctan", "ln", "log", "e^", "10^"],
        aliases: {},
        name: "Norsk Nynorsk",
        percentTranslated: 100
    }
      , ee = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tlhabelelo", "hwidinyetša go la nngele/la go ja"],
        microbitWhen: ["šutile", "šikinyegile", "fofile"],
        osis: ["dingwalwa tše dingwe tša motšeakarolo"],
        definePrefix: ["hlalosa"],
        defineSuffix: [],
        palette: {
            Motion: "Mosepelo",
            Looks: "Tebelelego",
        ...
        math: ["abs", "floor", "ceiling", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "Ka gare", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Sepedi",
        percentTranslated: 100
    }
      , ae = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ton", "equilibrar drecha/esquèrra"],
        microbitWhen: ["bolegat", "brandit", "sautat"],
        osis: ["autres escripts dins sprite"],
        definePrefix: ["define"],
        defineSuffix: [],
        palette: {
            Motion: "Moviment",
        ...
        math: ["abs", "arredondit.inf", "arredondit.sup", "rasiga", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {},
        name: "Occitan",
        percentTranslated: 100
    }
      , oe = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["ଧ୍ବନୀ ର ସ୍ତର", "ବାମ-ଡାହାଣ କୁ ଦେଖାଅ"],
        microbitWhen: ["ଘୁଞ୍ଚିଗଲା", "ହଲିଗଲା", "ଡେଇଁପଡ଼ିଲା"],
        osis: ["ସ୍ପ୍ରାଇଟ ରେ ଥିବା ଅନ୍ୟ ଲିପି"],
        definePrefix: [],
        defineSuffix: ["କୁ", "ବୁଝାଅ"],
        palette: {
            Motion: "ଗତି",
            Looks: "ରୂପ",
            Sound: "ଶବ୍ଦ",
        ...
        math: ["ଏବିଏସ", "ତଳ", "ଛାତ", "sqrt", "sin", "cos", "tan", "asin", "cosec", "cot", "ln", "log", "e ^", "10^"],
        aliases: {},
        name: "ଓଡ଼ିଆ",
        percentTranslated: 100
    }
      , te = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["płynność dźwięku", "przesuń w lewo/prawo"],
        microbitWhen: ["poruszony", "potrząśnięty", "podrzucony"],
        osis: ["inne skrypty duszka"],
        definePrefix: ["definiuj"],
        defineSuffix: [],
        palette: {
            Motion: "Ruch",
            Looks: "Wygląd",
        ...
        math: ["wartość bezwzględna", "podłoga", "sufit", "pierwiastek kwadratowy", "sinus", "cosinus", "tangens", "arcus sinus", "arcus cosinus", "arcus tangens", "logarytm naturalny", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , ne = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tom", "canal esquerdo/direito"],
        microbitWhen: ["se mover", "for abanado", "saltar"],
        osis: ["os teus outros guiões"],
        definePrefix: ["Define"],
        defineSuffix: [],
        palette: {
            Motion: "Movimento",
        ...
        math: ["o valor absoluto", "o chão (o maior inteiro não superior)", "o tecto (menor inteiro não inferior)", "a raiz quadrada", "o seno", "o cosseno", "a tangente", "o arco-seno", "o arco-cosseno", "o arco-tangente", "o logaritmo natural", "o logaritmo", "a exponencial", "10 ^"],
        aliases: {
      ...
      , Oe = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["tom", "balanço esquerda/direita"],
        microbitWhen: ["mover", "agitar", "pular"],
        osis: ["outros scripts no ator"],
        definePrefix: ["defina"],
        defineSuffix: [],
        palette: {
            Motion: "Movimento",
        ...
        math: ["módulo", "arredondamento para baixo de", "arredondamento para cima de", "raiz quadrada", "sen", "cos", "tg", "arcsen", "arccos", "arctg", "ln", "logaritmo", "e elevado à", "10 elevado à"],
        aliases: {},
      ...
      , ie = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["luqyay", "paniyay alliqman / ichuqman"],
        microbitWhen: ["musuqmi", "tapsiy", "pawarqun"],
        osis: ["huk qillqaykuna ipupi"],
        definePrefix: ["nin"],
        defineSuffix: [],
        palette: {
            Motion: "Muyuy",
        ...
        math: ["abs", "allpa", "qata", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "in", "Qallarichiy", "Y ^", "10 ^"],
        aliases: {},
        name: "Kichwa",
        percentTranslated: 100
    }
      , Te = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["roa roatano", "haka iri te reʾo o a te maui o a te mataʾu"],
        microbitWhen: ["moved", "shaken", "jumped"],
        osis: ["te tahi programa i te sprite"],
        definePrefix: ["haka", "tano", "te"],
        defineSuffix: [],
        palette: {
            Motion: "makenu",
      ...
      , Ee = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["înălțimea sunetului", "deplasare la stânga/dreapta"],
        microbitWhen: ["mutat", "scuturat", "sărit"],
        osis: ["alte scripturi pentru personaj"],
        definePrefix: ["definește"],
        defineSuffix: [],
        palette: {
            Motion: "Mișcare",
            Looks: "Aspect",
        ...
        math: ["modul", "partea întreagă", "rotunjire prin adaos", "radical", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , se = {
        ...
        dropdowns: {},
        ignorelt: [],
        soundEffects: ["высота тона", "звучание слева/справа"],
        microbitWhen: ["передвинулись", "встряхнули", "подпрыгнули"],
        osis: ["другие скрипты спрайта"],
        definePrefix: ["определить"],
        defineSuffix: [],
        palette: {
            Motion: "Движение",
            Looks: "Внешний вид",
        ...
        math: ["модуль", "целое меньшее", "целое большее", "квадратный корень", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
        aliases: {
      ...
      , re = {
        ...
        sk: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["frekvencia", "stereo"],
            microbitWhen: ["pohybe", "zatrasení", "skoku"],
            osis: ["moje iné scenáre"],
            definePrefix: ["blok"],
            defineSuffix: [],
            palette: {
                Motion: "Pohyb",
            ...
            math: ["abs", "zaokrúhli nadol", "zaokrúhli nahor", "odmocnina", "sin", "cos", "tg", "arcsin", "arccos", "arctg", "ln", "log", "exp", "10 ^"],
            aliases: {},
            name: "Slovenčina",
            percentTranslated: 100
        },
        sl: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["višina tona", "premik levo/desno"],
            microbitWhen: ["premaknjeno", "streseno", "poskok"],
            osis: ["ostale ukaze za ta lik"],
            definePrefix: ["definiraj"],
            defineSuffix: [],
            palette: {
                Motion: "Gibanje",
            ...
            math: ["absolutna vrednost", "zaokroženo navzdol", "zaokroženo navzgor", "kvadratni koren", "sin", "cos", "tg", "arcsin", "arccos", "arctg", "ln", "log", "e ^", "10 ^"],
            aliases: {
        ...
        sr: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["висина тона", "померање лево/десно"],
            microbitWhen: ["померен", "протресен", "скок"],
            osis: ["друге програме лика"],
            definePrefix: ["дефиниши"],
            defineSuffix: [],
            palette: {
                Motion: "Кретање",
                Looks: "Изглед",
            ...
            math: ["абс", "цео део", "цео+1", "корен", "sin", "cos", "tg", "arcsin", "arccos", "arctan", "ln", "log", "e ^", "10 ^"],
            aliases: {},
            name: "Српски",
            percentTranslated: 100
        },
        sv: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["tonhöjd", "panorera vänster/höger"],
            microbitWhen: ["rör sig", "skaka", "hoppa"],
            osis: ["andra skript i sprajten"],
            definePrefix: ["definiera"],
            defineSuffix: [],
            palette: {
                Motion: "Rörelse",
                Looks: "Utseende",
            ...
            math: ["abs", "golv", "tak", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
            aliases: {},
            name: "Svenska",
            percentTranslated: 100
        },
        sw: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["uzito wa sauti", "peleka sauti kushoto/kulia"],
            microbitWhen: ["inaposongwa", "inapotikiswa", "inaporushwa"],
            osis: ["hati nyingine katika kihusika"],
            definePrefix: ["fafanua"],
            defineSuffix: [],
            palette: {
                Motion: "Mwendo",
                Looks: "Muonekano",
            ...
            math: ["abs", "kadiria chini namba kamili", "kadiria juu namba kamili", "kipeo cha pili", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
            aliases: {},
            name: "Kiswahili",
            percentTranslated: 100
        },
        th: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["เสียงสูงต่ำ", "แพนเสียงซ้าย/ขวา"],
            microbitWhen: ["เคลื่อนไหว", "เขย่า", "กระโดด"],
            osis: ["สริปต์อื่นในตัวละคร"],
            definePrefix: ["กำหนด"],
            defineSuffix: [],
            palette: {
                Motion: "เคลื่อนไหว",
            ...
            math: ["ค่าสัมบูรณ์", "พื้น", "เพดาน", "รากที่สอง", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
            aliases: {},
            name: "ไทย",
            percentTranslated: 100
        },
        tn: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["segalo", "letswela la molema/moja"],
            microbitWhen: ["sutisitswe", "reketlisiwa", "tloletse"],
            osis: ["makwalo a mangwe mo go sprite"],
            definePrefix: ["tlhalosa"],
            defineSuffix: [],
            palette: {
                Motion: "Motsamao",
                Looks: "Ditebego",
            ...
            math: ["abs", "boalo", "Ceiling", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "gare", "log", "e ^", "10 ^"],
            aliases: {},
            name: "Setswana",
            percentTranslated: 100
        },
        tr: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["ses perdesi", "sağa-sola kaydır"],
            microbitWhen: ["taşınmış", "sallanmış", "atlanmış"],
            osis: ["kukladaki diğer dizileri"],
            definePrefix: [],
            defineSuffix: ["i", "tanımla"],
            palette: {
                Motion: "Hareket",
                Looks: "Görünüm",
                Sound: "Ses",
            ...
            math: ["mutlak değer", "aşağı yuvarla", "yukarı yuvarla", "karekök", "sinüs", "kosinüs", "tanjant", "arcsinüs", "arckosinüs", "arctanjant", "ln", "logaritma", "e ^", "10 ^"],
            aliases: {
        ...
        uk: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["висота", "панорама"],
            microbitWhen: ["рухається", "струснуто", "підкинуто"],
            osis: ["інші скрипти цього спрайту"],
            definePrefix: ["визначити"],
            defineSuffix: [],
            palette: {
                Motion: "Рух",
                Looks: "Вигляд",
            ...
            math: ["abs", "менше ціле", "більше ціле", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
            aliases: {},
            name: "Українська",
            percentTranslated: 100
        },
        uz: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["ovoz balandligi", "ovoz manzili o'ng-chap"],
            microbitWhen: ["harakatlangan", "silkingan", "sakragan"],
            osis: ["boshqa spraytlardagi skriptlar"],
            definePrefix: [],
            defineSuffix: ["ni", "belgilash"],
            palette: {
                Motion: "Harakatlar",
                Looks: "Ko'rinishlar",
                Sound: "Ovozlar",
            ...
            math: ["modul", "pol", "ship", "sqrt", "sinus qiymati", "kosinus qiymati", "tan qiymati", "asinus qiymati", "akosinus qiymati", "atan qiymati", "Ichida", "logarifm", "e ^", "10 ^"],
            aliases: {},
            name: "Oʻzbekcha",
            percentTranslated: 100
        },
        vi: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["cao độ", "pan trái/phải"],
            microbitWhen: ["moved", "shaken", "jumped"],
            osis: ["other scripts in sprite"],
            definePrefix: ["định", "nghĩa"],
            defineSuffix: [],
            palette: {
                Motion: "Chuyển động",
                Looks: "Hiển thị",
            ...
            math: ["giá trị tuyệt đối", "làm tròn xuống", "trần", "căn bậc hai", "sin", "cos", "tan", "asin", "acos", "atan", "trong", "log", "e ^", "10 ^"],
            aliases: {},
            name: "Tiếng Việt",
            percentTranslated: 100
        },
        xh: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["inqanaba", "bhala ekhohlo/ekunene"],
            microbitWhen: ["isuile", "shukunyisiwe", "yatsiba"],
            osis: ["eminye imibhalo kwispraythi"],
            definePrefix: ["chaza"],
            defineSuffix: [],
            palette: {
                Motion: "intshukumo",
            ...
            math: ["abs", "umgangatho", "isilingi", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "phakathi", "log", "e ^", "10 ^"],
            aliases: {},
            name: "isiXhosa",
            percentTranslated: 100
        },
        zh_cn: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["音调", "左右平衡"],
            microbitWhen: ["移动", "晃动", "抛起"],
            osis: ["该角色的其他脚本"],
            definePrefix: ["定义"],
            defineSuffix: [],
            palette: {
            ...
            math: ["绝对值", "向下取整", "向上取整", "平方根", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
            aliases: {
        ...
        zh_tw: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["音高", "聲道左/右"],
            microbitWhen: ["移動", "晃動", "跳動"],
            osis: ["這個物件的其它程式"],
            definePrefix: ["定義"],
            defineSuffix: [],
            palette: {
            ...
            math: ["絕對值", "無條件捨去", "無條件進位", "平方根", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
            aliases: {
        ...
        zu: {
            ...
            dropdowns: {},
            ignorelt: [],
            soundEffects: ["izinga elidlulele / iphimbo", "jikisa isinxele-nangakwesokudla"],
            microbitWhen: ["nyakazile", "ukunyakaziswa", "gxumile"],
            osis: ["eminye imibhalo kumlingisi"],
            definePrefix: ["chaza"],
            defineSuffix: [],
            palette: {
                Motion: "Ukunyakaza",
            ...
            math: ["abs", "phansi", "uphahla", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "e ^", "10 ^"],
            aliases: {},
            name: "isiZulu",
            percentTranslated: 100
        }
    };
    window.scratchblocks.loadLanguages(re)
}();
